...
制作组的法语思维还有一个体现：他们自动把发育的一词多义带入到游戏中了。#bardes("play")的法语翻译是jouer，但是中文翻译是玩/演奏，这无疑是一件非常不合理的事情：诗人语为什么会有发展出和法语一样的一词多义呢？如果要更进一步，这些语言甚至可以有自己的一词多义，当然这就有些超纲了。
...
不过无论如何，巴别塔圣歌是一款具有开创性玩法的独特游戏。将某些专业性知识与解谜游戏结合起来已经屡见不鲜，例如Zach-like游戏中就有很多以编程为主题。但与这些游戏的玩法和故事几乎无关不同（SHENZHEN I/O和EXAPUNKS的玩法完全可以对换），巴别塔圣歌中的语言和这五个民族本身，以及整个游戏的叙事都是紧密结合的。语言的谜题，简朴文字背后的#bardes("beauty")，以及一个童话，共同构成了巴别塔圣歌的成功。
