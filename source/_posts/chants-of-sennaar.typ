...
#let (devots, guerriers, bardes, alchimistes, reclus) = ("Devots", "Guerriers", "Bardes", "Alchimistes", "Reclus").map(x => (..words) => span(class: "frame-wrapper", html.frame(say(x)(..words))))

#elem("link", rel: "stylesheet", href: "/themes/nothing/source/assets/css/site.css")[]
...
《巴别塔圣歌》（Chants of Sennaar）是一款以破译语言为核心玩法的游戏。游戏很明显参考了巴别塔的故事：故事发生在一座高塔中，玩家要破译其中各族的语言，使他们恢复交流，高塔才能重获生机。游戏英文名中的 Sennaar（一般作 Shinar，示拿#footnote(link("https://en.wikipedia.org/wiki/Shinar"))）也与此有关：禧年书 10:18-26 记载人们正是在示拿建造一座城和一座塔，而上帝变乱了他们的口音，他们就停工了。因此示拿全地被称作巴别，因为上帝在那里变乱天下人的言语。
...
制作组的法语思维还有一个体现：他们自动把法语的一词多义带入到游戏中了。#bardes("play")的法语翻译是 jouer，但是中文翻译是玩/演奏，这无疑是一件非常不合理的事情：诗人语为什么会有发展出和法语一样的一词多义呢？如果要更进一步，这些语言甚至可以有自己的一词多义，当然这就有些超纲了。
...
#elem("style", ".reclus td { padding: 1pt 0.5em; }")

#figure(
  caption: [隐士的几句对话],
  div(class: "align-left reclus", {
    table(
      columns: 2,
      align: left + horizon,
      reclus("you", "help", "myPeople"), [你救了我的族人。],
      reclus("myPeople", "help", "tower"), [我的族人将拯救高塔。],
      reclus("us", "talk", "peoples"), [我们将与各个民族商谈。],
    )
  })
)
...
不过无论如何，巴别塔圣歌是一款具有开创性玩法的独特游戏，独特的核心玩法使其自成一类。将某些专业性知识与解谜游戏结合起来已经屡见不鲜，例如 Zach-like 游戏中就有很多以编程为主题。但与这些游戏的玩法和故事几乎无关不同（SHENZHEN I/O 和 EXAPUNKS 的玩法完全可以对换），巴别塔圣歌中的语言和这五个民族本身，以及整个游戏的叙事都是紧密结合的。语言的谜题，简朴文字背后的#bardes("beauty")，以及一个童话，共同构成了巴别塔圣歌的成功。
