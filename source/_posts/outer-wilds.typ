...
在一个传统的RPG游戏中，这不构成一个问题：玩家已经学会了把通过等级、技能、武器、道具变强作为自己的目标，就好像没有明确目标的大学生会把主要的精力用在GPA上，现代人也可以不假思索地把一般等价物作为自己的信仰。但是在星际拓荒，玩家几乎是立即遭逢了这个经典的存在主义之问：你有什么计划？你打算在游戏里做什么？你为什么打开这个游戏？*你想在这个游戏里追寻什么样的意义？*而头顶漫漫繁星的玩家，也正如掉入井里的泰勒斯一样，将回答那个哲学的基本问题作为了自己的目标：认识这个宇宙。好在泰勒斯终其一生都生活在米利都，而玩家，由于拥有哈斯人的木头航天飞船，能够轻易触及宇宙。

星际拓荒拥有一个由游戏内的物理规律支配着的，完全不以玩家行为和意志为转移的宇宙。即使玩家放下手柄，行星仍会在既定的轨道上旋转，宇宙也会以22分钟为周期重启。而不仅玩家无法跨越循环留下自己存在的痕迹，甚至在同一个循环之内玩家都无法使用道具对环境进行任何的改变。玩家所控制的角色基本上就是一台移动摄像机。可以说，这个宇宙是*坚硬*的，它不仅以既定的步伐运行，而且丝毫不受玩家的打扰。事实上，这个宇宙是以一个在场形而上学的方式建构的，天生拒斥主体性，玩家的存在才被如此抑制，而这反过来又成就了宇宙的宏大，就像中世纪的基督教需要贬抑人的存在来体现最高存在者的崇高。宇宙的浩瀚和玩家的渺小，相对立构成了这个游戏的美学特征之一。而当玩家失去了改变世界的手段，他也就只剩下认识世界一条路可以选择。
...
而星际拓荒的结局正是在用一个物理实在回应玩家的最终意义。其实游戏结局与基督教最后审判的结构非常相似：结束循环前往宇宙之眼就是玩家游戏生命的死亡，新宇宙就是审判之后的复活，新宇宙中依据玩家的经历而诞生不同的种族对应上帝依据人在其第一次生命中的作为进行的审判，而宇宙之眼，或者说宇宙规律本身，就是这里的上帝。新宇宙是神的国度中的福乐，它的意义是由宇宙规律担保的，然而正如之前所说，事物，即使是作为至高存在的宇宙本身，都无法成为其自身的意义。宇宙之眼逾越了挪麦人的认识过程，直接以物理实在的形式呈现在玩家眼前，除了让玩家感到夙愿已竟之外，无法成功构建起任何额外的意义——因为此岸的意义只能在此岸之内建构，但是再也不可能有一群挪麦人围着它进行阐释，赋予意义了，而一个物理实在永远无法填补一个意义之问的空缺。在此基础上，即使结局的内容本身再精良，也只不过是把宝剑的攻击力提升到了10000点，这个失败是结构性的。在结局处，星际拓荒遭遇了其命定的失败。
